#include "menu_themes_list.h"

#include "..\..\..\imgui\imgui.h"
#include "..\..\..\cvars.h"

CMenuThemesList::CMenuThemesList()
{
}
...
void CMenuThemesList::DefaultColorTheme()
{
...
void CMenuThemesList::SimplifiedWhiteRed()
{
	static auto& style = ImGui::GetStyle();
...
void CMenuThemesList::SimplifiedNightRed()
{
	static auto& style = ImGui::GetStyle();
...
void CMenuThemesList::SimplifiedWhiteOrange()
{
	static auto& style = ImGui::GetStyle();
	style.Colors[ImGuiCol_Text] = ImColor(0, 0, 0, 255);
	style.Colors[ImGuiCol_TextDisabled] = ImColor(102, 102, 102, 255);
...
void CMenuThemesList::SimplifiedNightOrange()
{
	static auto& style = ImGui::GetStyle();
...
void CMenuThemesList::SimplifiedWhiteCyan()
{
	static auto& style = ImGui::GetStyle();
...
void CMenuThemesList::SimplifiedNightCyan()
{
	static auto& style = ImGui::GetStyle();
	style.Colors[ImGuiCol_Text] = ImColor(255, 255, 255, 205);
	style.Colors[ImGuiCol_TextDisabled] = ImColor(98, 98, 98, 255);
