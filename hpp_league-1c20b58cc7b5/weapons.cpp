...
void CBasePlayerWeapon::_UpdateAccuracy()
{
	DWORD dwInitPoint = g_Offsets.m_dwInitPoint;

	switch (data.m_iWeaponID) {
	case WEAPON_AK47:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x25)) + 0xF8));
		break;
	case WEAPON_AUG:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x2B)) + 0xF8));
		break;
	case WEAPON_DEAGLE:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x3D)) + 0xF8));
		break;
	case WEAPON_ELITE:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x7)) + 0xF8));
		break;
	case WEAPON_FAMAS:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0xA9)) + 0xF8));
		break;
	case WEAPON_FIVESEVEN:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0xD)) + 0xF8));
		break;
	case WEAPON_G3SG1:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x4F)) + 0xF8));
		break;
	case WEAPON_GALIL:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0xA3)) + 0xF8));
		break;
	case WEAPON_GLOCK18:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x5B)) + 0xF8));
		break;
	case WEAPON_M4A1:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x79)) + 0xF8));
		break;
	case WEAPON_M249:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x6D)) + 0xF8));
		break;
	case WEAPON_MAC10:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x7F)) + 0xF8));
		break;
	case WEAPON_MP5N:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x19)) + 0xF8));
		break;
	case WEAPON_P90:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x8B)) + 0xF8));
		break;
	case WEAPON_P228:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x85)) + 0xF8));
		break;
	case WEAPON_SG550:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x55)) + 0xF8));
		break;
	case WEAPON_SG552:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x1F)) + 0xF8));
		break;
	case WEAPON_TMP:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x97)) + 0xF8));
		break;
	case WEAPON_UMP45:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x13)) + 0xF8));
		break;
	case WEAPON_USP:
		data.m_flAccuracy = (*(float*)((*(DWORD*)(dwInitPoint + 0x1)) + 0xF8));
		break;
	default:
		data.m_flAccuracy = 0.f;
		break;
	}
}
...
void CBasePlayerWeapon::Update()
{
	...
	//g_Engine.Con_NPrintf(10, "%f", data.m_flAccuracy);
	//g_Engine.Con_NPrintf(11, "%f", data.m_flSpread);
	//g_Engine.Con_NPrintf(12, "%i", IsInBurst());
}
