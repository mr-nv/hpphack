...
namespace ImGui
{
	...
	IMGUI_API void			DrawPoint(float angle, float radius, ImVec2 pos, float size, const ImColor& col);
	IMGUI_API void          Loading(const ImVec2& pos, float size, const ImVec4& col, float curtime);
	IMGUI_API void          TextCenter(const char* fmt, ...);
} // namespace ImGui
