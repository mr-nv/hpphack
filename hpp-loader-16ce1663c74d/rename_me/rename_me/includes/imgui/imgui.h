...
namespace ImGui
{
	...
	IMGUI_API void			NextLine(int spacing_count = 1, float offset_from_start_x = -1.f);
...
struct ImFontAtlas
{
    ...
    IMGUI_API ImFont*           AddFontDefault(float font_size, const ImFontConfig* font_cfg = NULL);
